<div data-preview="#<?php echo e($field['name']); ?>" data-aspectRatio="<?php echo e(isset($field['aspect_ratio']) ? $field['aspect_ratio'] : 0); ?>" data-crop="<?php echo e(isset($field['crop']) ? $field['crop'] : false); ?>" <?php echo $__env->make('admin::panel.inc.field_wrapper_attributes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>>
    <div>
    ...
    <div class="row">
        <div class="col-sm-6" style="margin-bottom: 20px;">
            <img id="mainImage" src="<?php echo e(url( (isset($field['prefix']) ? $field['prefix'] : '') . (old($field['name']) ? old($field['name']) : (isset($field['value']) ? \Storage::disk($field['disk'])->url($field['value']) : (isset($field['default']) ? $field['default'] : '') )))); ?>">
        </div>
...
<?php if($xPanel->checkIfFieldIsFirstOfItsType($field, $fields)): ?>
    ...
    <link href="<?php echo e(asset('vendor/admin/cropper/dist/cropper.min.css')); ?>" rel="stylesheet" type="text/css" />
    <style>
        .hide {
            display: none;
        }
    ...
    <script src="<?php echo e(asset('vendor/admin/cropper/dist/cropper.min.js')); ?>"></script>
    <script>
...
<?php /**PATH /home/developer/public_html/resources/views/vendor/admin/panel/fields/image.blade.php ENDPATH**/ ?>