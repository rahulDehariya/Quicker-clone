				...
				<?php if(!config('settings.footer.hide_links')): ?>
					...
					<div class="<?php echo e($colClass2); ?>">
						<div class="footer-col">
							...
							<ul class="list-unstyled footer-nav">
								...
								<?php if(!empty(config('lang.abbr')) and !empty(config('country.icode'))): ?>
					...
					<div class="<?php echo e($colClass3); ?>">
						<div class="footer-col">
							...
							<ul class="list-unstyled footer-nav">
								<?php if(!auth()->user()): ?>
									<li><a href="<?php echo e(lurl(trans('routes.login'))); ?>"> <?php echo e(t('log_in')); ?> </a></li>
...
<?php /**PATH /home/developer/public_html/resources/views/errors/layouts/inc/footer.blade.php ENDPATH**/ ?>