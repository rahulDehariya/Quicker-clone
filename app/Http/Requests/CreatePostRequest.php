...
class CreatePostRequest extends RequestPost
{
	...
	public function rules()
	{
		$rules = [
			...
			'title'        => ['required', new BetweenRule(2, 150), new MbAlphanumericRule(), new BlacklistTitleRule()],
			'description'  => ['required', new BetweenRule(5, 6000), new MbAlphanumericRule(), new BlacklistWordRule()],
